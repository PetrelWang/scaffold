...
import com.bbc.exception.BaseException;
import com.bbc.dto.OssFile;
import com.bbc.service.OssTemplate;
import io.minio.*;
...
public class MinioTemplate implements OssTemplate {
     ...
     */
    @Resource
    private com.bbc.minio.MinioProperties ossProperties;
    ...
    public OssFile upLoadFile(String folderName, String fileName, MultipartFile file) {
        if (file == null || file.isEmpty()) {
            throw new BaseException(400, "不能是空文件");
        }
        // 文件大小
